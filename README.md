...
<header>
  ...
  <p class="muted">
    Doomfall is my “choose your own apocalypse” overhaul for <strong>Might and Magic Merge (MMMerge)</strong>.
  ...
  <div class="note">
    <p style="margin:0;">
      Includes the <strong>Extra Class Pack / Advanced Classes</strong> module inside Doomfall, so you can get a complete setup without stacking a dozen separate installs.
    </p>
  </div>
</header>

<main>
<section class="card" id="doomfall">
  <h2 style="margin-top:0;">Doomfall — Modular gameplay overhaul for MMMerge (Might and Magic Merge)</h2>

  <p class="muted">
    Doomfall is the kind of mod you install when you love <strong>Might and Magic Merge (MMMerge)</strong>,
    but you also want the game to bend a little further without snapping. It’s a deep gameplay overhaul that
    pushes the engine past its “normal comfort zone”… while still letting beginners play it like a chill vanilla run,
    thanks to fully modular settings.
  </p>

  <div class="note">
    <p style="margin:0;">
      Doomfall isn’t a simple “+50% monster HP” patch. It reshapes <strong>how challenge is generated at runtime</strong> in MMMerge,
      so you can dial the experience from casual exploration to endgame chaos, without breaking map flow or long campaigns.
    </p>
  </div>

  <h3>Part of Heroes of the Nexus (and includes Extra Class Pack)</h3>
  <p>
    Doomfall is the <strong>second chapter</strong> of the <strong>Heroes of the Nexus</strong> project, and it comes with the
    <a href="https://www.nexusmods.com/mightandmagicviii/mods/20" target="_blank" rel="noopener"><strong>Extra Class Pack</strong></a>
    built in. In practice, that means you don’t have to juggle ten different downloads to get the “full experience”.
  </p>
  ...
  <ol>
    ...
    <li>
      Download base <strong>MMMerge</strong>:
      <a class="btn" href="https://1drv.ms/u/s!AklOx6zaOmQgbHB1-Avia15ruaI?e=H4IcBJ" target="_blank" rel="noopener">Download MMMerge</a>
    </li>
    <li>
      Download <strong>Doomfall</strong> on Nexus:
      <a class="btn" href="https://www.nexusmods.com/mightandmagicviii/mods/23" target="_blank" rel="noopener">Download Doomfall</a>
    </li>
  </ol>

  <p class="muted">
    Doomfall already bundles: <strong>Extra Class Pack</strong>, MMMerge patches, multiplayer compatibility, and the full character pack.
  </p>

  <p>Join the Discord: <a href="https://discord.gg/hcD4b9yXdj" target="_blank" rel="noopener">discord.gg/hcD4b9yXdj</a></p>

  <p>If you love the mod, buy the developer a coffee: <a href="https://www.patreon.com/c/mightmagicmergedoomfallmod/membership" target="_blank" rel="noopener">Buy a coffee ☕</a></p>

  <h3>Something for every playstyle (seriously)</h3>
  <p>
    The best way I can describe Doomfall as a player: it never tells you “this is the only correct way to play”.
    It gives you a toolbox, and <strong>you</strong> decide what kind of run you want.
  </p>

  <ul>
    <li>Want <strong>vanilla difficulty</strong> but a world packed with more monsters? <strong>You can.</strong></li>
    <li>Want to keep everything vanilla and only inject <strong>new unique bosses</strong> here and there? <strong>You can.</strong></li>
    <li>Want to tweak <strong>combat difficulty</strong> without touching density at all? <strong>You can.</strong></li>
    <li>Want everything set to vanilla and just enjoy occasional “oh no, it’s a boss” moments? <strong>Totally doable.</strong></li>
  </ul>

  <p class="note">
    <strong>Nothing is mandatory.</strong> Doomfall doesn’t force a preset experience — it lets you shape MMMerge exactly the way you like.
  </p>

  <h3>The 3 Doomfall settings (independent systems)</h3>
  <p>
    Doomfall splits difficulty into <strong>three separate knobs</strong> you can adjust independently.
    This is what makes it feel so flexible: you’re not locked into “hard mode = everything goes crazy”.
  </p>

  <figure style="margin: 14px 0;">
    <img class="img" src="https://heroesofthenexus.com/assets/images/doomfall-3.png" alt="Doomfall settings: Difficulty, Density, Bosses (MMMerge)" loading="lazy" />
    <figcaption class="muted" style="margin-top:8px;">
      The three sliders: Difficulty, Density, Bosses — each one can be changed without touching the others.
    </figcaption>
  </figure>

  <div class="grid">
    <div class="card">
      <h4 style="margin:0 0 6px 0;">1) Difficulty</h4>
      <p>
        This controls the <strong>overall combat intensity</strong> in Might and Magic Merge:
        how punishing fights feel, how dangerous enemies are, and how much pressure you’re under.
      </p>
      <p class="muted">
        Low presets (<em>Piece of Cake</em>, <em>Very Easy</em>, <em>Easy</em>) are perfect if you’re new to MMMerge,
        or you just want a relaxed adventure. Higher values ramp up hard: enemies hit harder, survive longer,
        and fights turn into real tests — the “jump straight into the fire” type of scaling.
      </p>
      <p class="muted"><strong>Key point:</strong> you can change Difficulty without touching Density or Bosses.</p>
    </div>
    ...
    <div class="card">
      ...
      <p class="muted">
        The crazy part? It can scale to massive encounters with hundreds of enemies — even up to
        <strong>~1000 active monsters</strong> on a single map — while keeping the original monster distribution intact.
      </p>
      <p class="muted">
        If you want more action but don’t want spongey enemies, Density is your best friend.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        the world has these elite encounters that break the routine in the best way.
      </p>
      <p class="muted">
        Bosses are built from existing monsters, then enhanced with special abilities or elite combos,
        so they feel like “this map’s monsters, but evolved”, not random replacements.
      </p>
    </div>
  </div>

  <h3>Total freedom (mix or isolate)</h3>
  <ul>
    <li>Change <strong>only</strong> Density.</li>
    <li>Change <strong>only</strong> Difficulty.</li>
    <li>Enable <strong>only</strong> Bosses.</li>
    <li>Or combine all three for full Doomfall chaos.</li>
  </ul>

  <h3>Beginner-friendly by design</h3>
  <p>
    Doomfall can get extreme, but it’s also built to be playable for newcomers.
    The low presets (<strong>Piece of Cake</strong>, <strong>Very Easy</strong>, <strong>Easy</strong>) exist for a reason:
    you can learn the systems at your pace, then gradually push one slider at a time.
  </p>

  <h3>Core philosophy</h3>
  <p class="note">
    Doomfall’s core idea is simple: <strong>difficulty in MMMerge should be customizable</strong>.
    You decide how far the game goes — not fixed presets, not engine limits.
  </p>

  <figure style="margin: 14px 0;">
    <img class="img" src="https://heroesofthenexus.com/assets/images/doomfall-4.png" alt="Doomfall gameplay: modular difficulty, density, bosses" loading="lazy" />
  </figure>

  <h3>What Doomfall actually adds (player breakdown)</h3>

  <h4>Full difficulty control</h4>
  <p>
    Difficulty scaling is modular and independent from monster density.
    You can fine-tune overall challenge, damage pressure, survivability, and combat intensity,
    which makes progression feel smooth — from beginner-friendly runs to real endgame-level brutality,
    even on familiar MMMerge maps.
  </p>

  <h4>Extreme monster density (engine-aware)</h4>
  <p>
    Doomfall can push density far beyond vanilla. The system is engineered to stay stable:
    intelligent pseudo-spawning, preservation of the original monster distribution,
    and filtering out unstable entities (like town NPCs/guards) so the game doesn’t implode.
  </p>

  <h4>Dynamic boss system (50+ extra bosses)</h4>
  <p>
    Doomfall introduces <strong>more than 50 additional bosses</strong>, generated dynamically from the map’s actual monster population.
    They’re not random replacements:
  </p>
  <ul>
    <li>Picked from real map populations (so they fit the area)</li>
    <li>Minority monster types are avoided to keep things fair and readable</li>
    <li>Spawned safely after map load</li>
  </ul>

  <h4>Boss skills &amp; affixes (the “oh no” moments)</h4>
  <p>
    Bosses can roll powerful abilities that change how fights play out — things like:
    <strong>Adamantite</strong>, <strong>Berserker</strong>, <strong>Blinker</strong>, <strong>Voodoo</strong>,
    <strong>Diamondskin</strong>, <strong>Immolator</strong>, <strong>Horror</strong>, <strong>Lifedrinker</strong>,
    <strong>Mana Vampire</strong>, <strong>Petrifier</strong>, <strong>Plagueborn</strong>, <strong>Summoner</strong>,
    <strong>Terror</strong>, <strong>Void Stalker</strong>, <strong>Venomous</strong>, <strong>Wrath Animator</strong>, and more.
  </p>

  <h4>Elite bosses (rare, memorable, mean)</h4>
  <p>
    Sometimes a boss becomes <strong>Elite</strong>: multiple synergistic abilities, extra durability,
    and a fight that can completely hijack your plan for the next five minutes (in a good way).
    Examples include:
    <strong>Destroyer</strong>, <strong>Gladiator</strong>, <strong>Phantom</strong>, <strong>War Bringer</strong>,
    <strong>Spectral Overlord</strong>, <strong>Colossus</strong>, <strong>Bastion</strong>.
  </p>

  <h4>Engine-safe &amp; multiplayer-safe design</h4>
  <p>
    Even with ridiculous settings, Doomfall prioritizes stability in the MMMerge engine:
    delayed safe spawning, locks to prevent duplicate bosses, full New Game reset handling,
    dynamic naming to avoid conflicts, and multiplayer-safe behavior.
  </p>

  <h3>Who Doomfall is for</h3>
  <ul>
    <li>Beginners who want a customizable MMMerge experience</li>
    <li>Players who enjoy smooth difficulty progression</li>
    <li>Veterans hunting for brutal endgame challenge</li>
    <li>Experimenters who love pushing systems to their limits</li>
    <li>Multiplayer groups looking for scalable chaos</li>
  </ul>

  <h3>Who it’s not for</h3>
  <ul>
    <li>Players who want an almost untouched, classic MMMerge run with minimal variation</li>
    <li>Players who only want a single fixed “ultra-hardcore forever” preset (Doomfall is about choice)</li>
  </ul>

  <h3>In short</h3>
  <p class="note">
    Doomfall turns Might and Magic Merge into a fully modular sandbox where
    <strong>Difficulty</strong>, <strong>Density</strong>, and <strong>Boss encounters</strong> are no longer limited by the original setup —
    only by how far you decide to push the sliders.
  </p>

  <h3>FAQ — Doomfall for MMMerge</h3>

  <h4>Can I max all three settings?</h4>
  <p>
    Yes — you can push Difficulty, Density, and Bosses to the maximum.
    Just don’t be surprised if the result is completely unhinged: the game can become genuinely overwhelming.
    (It’s fun… but it’s not subtle.)
  </p>

  <h4>Is Doomfall compatible with multiplayer?</h4>
  <p>
    Yes. Doomfall is designed with multiplayer in mind. Not every edge case is guaranteed to be solved forever,
    but the foundation is multiplayer-safe, and patches can address anything weird that shows up in the wild.
  </p>

  <h4>Why are new classes included?</h4>
  <p>
    Because the <strong>Extra Class Pack</strong> works naturally with the base MMMerge experience and gives a complete “ready-to-play” setup.
    It’s included so players can get the full package in one install — without forcing those classes into Doomfall’s difficulty systems.
  </p>
...
<section class="card">
  ...
  <div class="card">
    ...
    <div style="position:relative;padding-top:56.25%;border-radius:14px;overflow:hidden;border:1px solid #21314b;background:#0b0d10;">
      <iframe
        src="https://www.youtube.com/embed/bYeKl9I2LEo"
        title="Advanced Class for MMMerge — Showcase"
        style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowfullscreen></iframe>
    </div>
    ...
    <p class="muted" style="margin-top:10px;">
      Direct link:
      <a href="https://youtu.be/bYeKl9I2LEo?si=nEwyUfLix-8MKRZk" target="_blank" rel="noopener">youtu.be/bYeKl9I2LEo</a>
    </p>
  </div>
...
<section class="card">
  ...
  <div class="card">
    ...
    <div style="position:relative;padding-top:56.25%;border-radius:14px;overflow:hidden;border:1px solid #21314b;background:#0b0d10;">
      <iframe
        src="https://www.youtube.com/embed/09HG-g_MK3s"
        title="Advanced Class for MMMerge — Showcase"
        style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowfullscreen></iframe>
    ...
    <p class="muted" style="margin-top:10px;">
      Direct link:
      <a href="https://youtu.be/09HG-g_MK3s?si=mRiTc2Vs5DgM3Lq9" target="_blank" rel="noopener">youtu.be/09HG-g_MK3s</a>
    </p>
  </div>
...
<footer class="muted">
  <p>
    Tags: Might and Magic, Might and Magic Merge, MMMerge, MM6, MM7, MM8, Enroth, Antagarich, Jadame, mod, new classes, Heroes of Might and Magic.
  </p>
</footer>
</body>
</html>
